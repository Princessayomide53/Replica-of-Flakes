...
const About = () => {
  ...
  return (
    <section className="overflow-hidden bg-[#040013] h-[158rem] md:h-[165rem] lg:h-[177.625rem] xl:h-[180.625rem] ">
      <NavBar />
      <div className="pt-[7.95rem] md:pt-[12.75rem] relative">
        <h2 className="text-white text-center text-[1.25rem] px-7 md:px-0 md:text-[2.2rem] leading-normal xl:text-[2.5rem] font-medium md:leading-[2rem] tracking-[0.0125rem]">
        ...
        <div className="flex flex-col md:flex-row  md:justify-center max-w-[21.5rem] md:max-w-[43rem] lg:max-w-[65rem] xl:max-w-[73rem] mx-auto gap-0 md:gap-[2rem] lg:gap-[2rem] pt-[2.5rem] md:pt-[5rem]">
          <img
            src={G1}
            alt=""
            className="lg:w-[35.12569rem] w-[20.8445rem] h-[19.07269rem]  xl:w-[40.12569rem] md:w-[28.375rem] md:h-[28.375rem] lg:h-[39.375rem] object-cover rounded-md"
          />
        ...
        <p className="text-white/90 max-w-[21.5rem]  md:max-w-[43rem] text-base lg:max-w-[57rem] xl:max-w-[73rem] pt-[2.49rem]  mx-auto md:pt-[4.94rem] flex justify-center lg:text-lg xl:text-[1.25rem] font-medium leading-[2rem] tracking-[0.00625rem]">
          ...
          conceptualization to user interaction fascinates me. I also love that
          i get to use my designs
          <br className="hidden xl:block" /> to create products that solve users
          problem and work on amazing projects that improve lives.{" "}
        </p>
        <div className="pt-[3.62rem] md:pt-[7.12rem] flex flex-col-reverse max-w-[21.5rem] md:max-w-[43rem] md:flex-row md:justify-evenly lg:max-w-[57rem] xl:max-w-[70rem] mx-auto">
          <div>
            <h5 className="text-[1.24238rem] md:text-[1.9375rem] pt-[0.5rem] pb-[2rem] text-white font-medium leadng-[2rem] tracking-[0.00969rem]">
              Hobbies and Funfacts
            </h5>

            <p className="text-white hidden md:gap-5 lg:gap-0 md:flex text-[0.80156rem] lg:text-lg xl:text-[1.25rem] font-normal leading-[2rem]">
              I designed a web application for the Lagos State
              <br className="" /> Residents Registration Agency (LASSRA) to help{" "}
              <br />
